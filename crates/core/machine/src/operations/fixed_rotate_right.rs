...
#[cfg(feature = "fuzzing")]
impl crate::fuzzing::DiffFuzzingTarget for FixedRotateRightOperation<p3_koala_bear::KoalaBear> {
    ...
    fn oracle((i, rot, _): &Self::Input) -> std::ops::ControlFlow<(), u32> {
        std::ops::ControlFlow::Continue(i.rotate_right((*rot).try_into().unwrap()))
    }
